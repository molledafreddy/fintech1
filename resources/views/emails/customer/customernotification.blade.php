            ...
            <tr>
              <td height="70">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td class="h1" style="padding: 1px 0 0 0;">
            ...
            <tr>
              <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td class="bodycopy">
                      Saludos, {{$data->cp_first_name}}
                      <br/><br/>
                       Se ha procesado exitosamente, pronto te contactaremos para realizar la entrevista y recaudos necesarios para la empresa: {{$data->name}}.

                       <br /><br />
                       Atentamente Fintech Mexico.
                    </td>
                  </tr>
                  <tr>
                  </tr>
