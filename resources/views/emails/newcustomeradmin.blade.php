                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td class="h1" style="padding: 5px 0 0 0;">
                      <img class="img img-resposinve" src="{{ asset('assets/logo.png')}}">
                    </td>
                  </tr>
                </table>
              </td>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td class="bodycopy">
                      Saludos, {{$data['name']}}
                      <br/><br/>
                      Se le ha asignado el rol de administrador de la empresa: {{$data['customer']}}
                    </td>
                  </tr>
                  <tr>
                    <td style="padding: 20px 0 0 0;">
                      <table class="buttonwrapper" bgcolor="#005481" border="0" cellspacing="0" cellpadding="0">
                           <tr>
                               <td class="button" height="45">
                                   <a class="btn-primary" href="{{url('/password/reset/'.$token)}}">Ingresar</a>
                               </td>
                           </tr>
                       </table>
                   </td>
