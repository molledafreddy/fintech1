                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                         ...
                         <div class="form-group{{ $errors->has('nacionality') ? ' has-error' : '' }}">
                            <label for="nacionality" class="col-md-4 control-label">Nacionality</label>

                            <div class="col-md-6">
                                <input id="nacionality" type="text" class="form-control" name="nacionality" value="{{ old('nacionality') }}" required autofocus>
